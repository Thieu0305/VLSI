...
module TLPLIC(	// @[generators/rocket-chip/src/main/scala/devices/tilelink/Plic.scala:132:9]
  ...
  wire             out_woready_4;	// @[generators/rocket-chip/src/main/scala/tilelink/RegisterRouter.scala:87:24]
  ...
  wire             _out_T_7 = {_out_back_front_q_io_deq_bits_index[22:19], _out_back_front_q_io_deq_bits_index[17:11], _out_back_front_q_io_deq_bits_index[8:0]} == 20'h0;	// @[generators/rocket-chip/src/main/scala/tilelink/RegisterRouter.scala:87:24]
  wire [31:0]      _out_womask_T_4 = {{8{_out_back_front_q_io_deq_bits_mask[7]}}, {8{_out_back_front_q_io_deq_bits_mask[6]}}, {8{_out_back_front_q_io_deq_bits_mask[5]}}, {8{_out_back_front_q_io_deq_bits_mask[4]}}};	// @[generators/rocket-chip/src/main/scala/tilelink/RegisterRouter.scala:87:24]
  wire             claimer_0 = _out_wofireMux_T & _out_back_front_q_io_deq_bits_read & out_backSel_4 & _out_T_7 & (|_out_womask_T_4);	// @[generators/rocket-chip/src/main/scala/tilelink/RegisterRouter.scala:87:24]
  ...
  `ifndef SYNTHESIS	// @[generators/rocket-chip/src/main/scala/devices/tilelink/Plic.scala:251:11]
    always @(posedge clock) begin	// @[generators/rocket-chip/src/main/scala/devices/tilelink/Plic.scala:251:11]
      if (~reset & claimer_0 & claimer_0 - 1'h1) begin	// @[generators/rocket-chip/src/main/scala/devices/tilelink/Plic.scala:251:{11,28,46}, generators/rocket-chip/src/main/scala/tilelink/RegisterRouter.scala:87:24]
      ...
      if (~reset & completer_0 & completer_0 - 1'h1) begin	// @[generators/rocket-chip/src/main/scala/devices/tilelink/Plic.scala:251:11, :268:{11,30,50}, :301:35, generators/rocket-chip/src/main/scala/tilelink/RegisterRouter.scala:87:24]
  ...
  `endif // not def SYNTHESIS
  wire [1:0]       _out_completer_0_T = {enables_0_0, 1'h0} >> completerDev;	// @[generators/rocket-chip/src/main/scala/devices/tilelink/Plic.scala:132:9, :178:26, :183:52, :301:51, generators/rocket-chip/src/main/scala/tilelink/RegisterRouter.scala:87:24, generators/rocket-chip/src/main/scala/util/package.scala:163:13]
  assign completer_0 = out_woready_4 & (&_out_womask_T_4) & _out_completer_0_T[0];	// @[generators/rocket-chip/src/main/scala/devices/tilelink/Plic.scala:301:{35,51}, generators/rocket-chip/src/main/scala/tilelink/RegisterRouter.scala:87:24]
  wire [2:0]       out_oindex = {_out_back_front_q_io_deq_bits_index[18], _out_back_front_q_io_deq_bits_index[10:9]};	// @[generators/rocket-chip/src/main/scala/tilelink/RegisterRouter.scala:87:24]
  wire [2:0]       _GEN = {_out_back_front_q_io_deq_bits_index[18], _out_back_front_q_io_deq_bits_index[10:9]};	// @[generators/rocket-chip/src/main/scala/tilelink/RegisterRouter.scala:87:24, src/main/scala/chisel3/util/OneHot.scala:58:35]
  assign out_backSel_4 = _GEN == 3'h4;	// @[generators/rocket-chip/src/main/scala/tilelink/RegisterRouter.scala:87:24, src/main/scala/chisel3/util/OneHot.scala:58:35]
  ...
  assign out_woready_4 = _out_wofireMux_T_2 & out_backSel_4 & _out_T_7;	// @[generators/rocket-chip/src/main/scala/tilelink/RegisterRouter.scala:87:24]
  wire [7:0]       _GEN_0 = {{1'h1}, {1'h1}, {1'h1}, {_out_T_7}, {1'h1}, {_out_T_7}, {_out_T_7}, {_out_T_7}};	// @[generators/rocket-chip/src/main/scala/devices/tilelink/Plic.scala:132:9, generators/rocket-chip/src/main/scala/tilelink/RegisterRouter.scala:87:24, generators/rocket-chip/src/main/scala/util/MuxLiteral.scala:49:10]
  wire [7:0][63:0] _GEN_1 = {{64'h0}, {64'h0}, {64'h0}, {{31'h0, maxDevs_0, 31'h0, threshold_0}}, {64'h0}, {{62'h0, enables_0_0, 1'h0}}, {{62'h0, pending_0, 1'h0}}, {{31'h0, priority_0, 32'h0}}};	// @[generators/rocket-chip/src/main/scala/devices/tilelink/Plic.scala:132:9, :167:31, :170:31, :172:26, :178:26, :185:22, generators/rocket-chip/src/main/scala/tilelink/RegisterRouter.scala:87:24, generators/rocket-chip/src/main/scala/util/MuxLiteral.scala:49:{10,48}]
  ...
  wire             claiming = claimer_0 & maxDevs_0;	// @[generators/rocket-chip/src/main/scala/devices/tilelink/Plic.scala:185:22, :252:49, generators/rocket-chip/src/main/scala/tilelink/RegisterRouter.scala:87:24]
  always @(posedge clock) begin	// @[generators/rocket-chip/src/main/scala/devices/tilelink/Plic.scala:132:9]
    if (_out_wofireMux_T_2 & _GEN == 3'h0 & _out_T_7 & _out_back_front_q_io_deq_bits_mask[4])	// @[generators/rocket-chip/src/main/scala/tilelink/RegisterRouter.scala:87:24, src/main/scala/chisel3/util/OneHot.scala:58:35]
    ...
    if (_out_wofireMux_T_2 & _GEN == 3'h2 & _out_T_7 & _out_back_front_q_io_deq_bits_mask[0])	// @[generators/rocket-chip/src/main/scala/tilelink/RegisterRouter.scala:87:24, src/main/scala/chisel3/util/OneHot.scala:58:35]
    ...
    else if (claiming | _gateways_gateway_io_plic_valid)	// @[generators/rocket-chip/src/main/scala/devices/tilelink/Plic.scala:160:27, :252:49, :257:15]
      pending_0 <= ~claiming;	// @[generators/rocket-chip/src/main/scala/devices/tilelink/Plic.scala:172:26, :252:49, :257:34]
  end // always @(posedge)
  `ifdef ENABLE_INITIAL_REG_	// @[generators/rocket-chip/src/main/scala/devices/tilelink/Plic.scala:132:9]
    ...
    initial begin	// @[generators/rocket-chip/src/main/scala/devices/tilelink/Plic.scala:132:9]
      ...
      `ifdef RANDOMIZE_REG_INIT	// @[generators/rocket-chip/src/main/scala/devices/tilelink/Plic.scala:132:9]
        ...
        pending_0 = _RANDOM[/*Zero width*/ 1'b0][2];	// @[generators/rocket-chip/src/main/scala/devices/tilelink/Plic.scala:132:9, :167:31, :172:26]
        enables_0_0 = _RANDOM[/*Zero width*/ 1'b0][3];	// @[generators/rocket-chip/src/main/scala/devices/tilelink/Plic.scala:132:9, :167:31, :178:26]
        maxDevs_0 = _RANDOM[/*Zero width*/ 1'b0][4];	// @[generators/rocket-chip/src/main/scala/devices/tilelink/Plic.scala:132:9, :167:31, :185:22]
        intnodeOut_0_REG = _RANDOM[/*Zero width*/ 1'b0][5];	// @[generators/rocket-chip/src/main/scala/devices/tilelink/Plic.scala:132:9, :167:31, :193:45]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  TLMonitor_30 monitor (	// @[generators/rocket-chip/src/main/scala/tilelink/Nodes.scala:27:25]
    .clock                (clock),
    .reset                (reset),
  ...
  LevelGateway gateways_gateway (	// @[generators/rocket-chip/src/main/scala/devices/tilelink/Plic.scala:160:27]
    ...
    .io_plic_complete (completer_0 & completerDev)	// @[generators/rocket-chip/src/main/scala/devices/tilelink/Plic.scala:270:28, :301:35, generators/rocket-chip/src/main/scala/tilelink/RegisterRouter.scala:87:24, generators/rocket-chip/src/main/scala/util/package.scala:163:13]
  ...
  assign auto_int_out_0 = intnodeOut_0_REG > threshold_0;	// @[generators/rocket-chip/src/main/scala/devices/tilelink/Plic.scala:132:9, :170:31, :193:{45,60}]
  ...
  assign auto_in_d_bits_data = _GEN_0[out_oindex] ? _GEN_1[out_oindex] : 64'h0;	// @[generators/rocket-chip/src/main/scala/devices/tilelink/Plic.scala:132:9, generators/rocket-chip/src/main/scala/tilelink/RegisterRouter.scala:87:24, generators/rocket-chip/src/main/scala/util/MuxLiteral.scala:49:10]
endmodule
