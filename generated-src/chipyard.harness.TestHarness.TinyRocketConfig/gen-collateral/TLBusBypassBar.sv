...
module TLBusBypassBar(	// @[generators/rocket-chip/src/main/scala/devices/tilelink/BusBypass.scala:66:9]
  ...
  wire [1:0] nodeIn_d_bits_param = bypass ? 2'h0 : auto_out_1_d_bits_param;	// @[generators/rocket-chip/src/main/scala/devices/tilelink/BusBypass.scala:81:21, :98:21]
  ...
  wire [1:0] _next_flight_T_10 = flight + {1'h0, d_dec & ~r_counter_3 & nodeIn_d_bits_opcode[2] & ~(nodeIn_d_bits_opcode[1])} + {1'h0, r_3 & ~r_counter} - {1'h0, d_dec};	// @[generators/rocket-chip/src/main/scala/devices/tilelink/BusBypass.scala:98:21, generators/rocket-chip/src/main/scala/tilelink/Edges.scala:71:{36,40,43,52}, :229:27, :231:25, :295:25, :310:26, :313:{26,37}, :324:{30,40,46}, src/main/scala/chisel3/util/Decoupled.scala:51:35]
  ...
  TLMonitor_33 monitor (	// @[generators/rocket-chip/src/main/scala/tilelink/Nodes.scala:27:25]
    .clock                (clock),
    .reset                (reset),
