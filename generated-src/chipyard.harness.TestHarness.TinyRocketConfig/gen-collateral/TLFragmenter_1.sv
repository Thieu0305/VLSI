...
module TLFragmenter_1(	// @[generators/rocket-chip/src/main/scala/tilelink/Fragmenter.scala:92:9]
  ...
  wire [6:0]  _repeater_io_deq_bits_source;	// @[generators/rocket-chip/src/main/scala/tilelink/Fragmenter.scala:274:30]
  wire [31:0] _repeater_io_deq_bits_address;	// @[generators/rocket-chip/src/main/scala/tilelink/Fragmenter.scala:274:30]
  wire [3:0]  _repeater_io_deq_bits_mask;	// @[generators/rocket-chip/src/main/scala/tilelink/Fragmenter.scala:274:30]
  reg  [3:0]  acknum;	// @[generators/rocket-chip/src/main/scala/tilelink/Fragmenter.scala:201:29]
  ...
  wire        dFirst = acknum == 4'h0;	// @[generators/rocket-chip/src/main/scala/tilelink/Fragmenter.scala:201:29, :205:29]
  wire [4:0]  _dsizeOH1_T = 5'h3 << auto_anon_out_d_bits_size;	// @[generators/rocket-chip/src/main/scala/util/package.scala:243:71]
  wire [3:0]  _GEN = ~(auto_anon_out_d_bits_source[3:0]);	// @[generators/rocket-chip/src/main/scala/tilelink/Fragmenter.scala:204:41, generators/rocket-chip/src/main/scala/util/package.scala:241:49]
  wire [2:0]  dFirst_size_hi = auto_anon_out_d_bits_source[3:1] & {1'h1, _GEN[3:2]};	// @[generators/rocket-chip/src/main/scala/tilelink/Fragmenter.scala:92:9, generators/rocket-chip/src/main/scala/util/package.scala:241:{47,49}, src/main/scala/chisel3/util/OneHot.scala:30:18]
  wire [2:0]  _dFirst_size_T_8 = {1'h0, dFirst_size_hi[2:1]} | {auto_anon_out_d_bits_source[0], ~(_dsizeOH1_T[1:0])} & {_GEN[1:0], _dsizeOH1_T[1]};	// @[generators/rocket-chip/src/main/scala/tilelink/Fragmenter.scala:92:9, generators/rocket-chip/src/main/scala/util/package.scala:241:{47,49}, :243:{46,71,76}, src/main/scala/chisel3/util/OneHot.scala:30:18, :31:18, :32:28]
  ...
  wire        drop = ~(auto_anon_out_d_bits_opcode[0]) & ~(auto_anon_out_d_bits_source[5] ? dFirst : auto_anon_out_d_bits_source[3:0] == 4'h0);	// @[generators/rocket-chip/src/main/scala/tilelink/Edges.scala:106:36, generators/rocket-chip/src/main/scala/tilelink/Fragmenter.scala:204:41, :205:29, :206:30, :231:54, :234:{20,30,33,37}]
  ...
  reg  [3:0]  gennum;	// @[generators/rocket-chip/src/main/scala/tilelink/Fragmenter.scala:303:29]
  wire        aFirst = gennum == 4'h0;	// @[generators/rocket-chip/src/main/scala/tilelink/Fragmenter.scala:303:29, :304:29]
  wire [3:0]  aFragnum = aFirst ? ~(_aOrigOH1_T[5:2]) : gennum - 4'h1;	// @[generators/rocket-chip/src/main/scala/tilelink/Fragmenter.scala:303:29, :304:29, :305:{30,79}, generators/rocket-chip/src/main/scala/util/package.scala:243:{46,71,76}]
  ...
  always @(posedge clock) begin	// @[generators/rocket-chip/src/main/scala/tilelink/Fragmenter.scala:92:9]
    if (reset) begin	// @[generators/rocket-chip/src/main/scala/tilelink/Fragmenter.scala:92:9]
      acknum <= 4'h0;	// @[generators/rocket-chip/src/main/scala/tilelink/Fragmenter.scala:201:29]
      dToggle <= 1'h0;	// @[generators/rocket-chip/src/main/scala/tilelink/Fragmenter.scala:92:9, :203:30]
      gennum <= 4'h0;	// @[generators/rocket-chip/src/main/scala/tilelink/Fragmenter.scala:303:29]
    end
      ...
      if (_GEN_0)	// @[src/main/scala/chisel3/util/Decoupled.scala:51:35]
        acknum <= dFirst ? auto_anon_out_d_bits_source[3:0] : acknum - {3'h0, auto_anon_out_d_bits_opcode[0] | auto_anon_out_d_bits_size == 2'h2};	// @[generators/rocket-chip/src/main/scala/tilelink/Edges.scala:106:36, generators/rocket-chip/src/main/scala/tilelink/Fragmenter.scala:201:29, :204:41, :205:29, :216:{32,56}, :221:{24,55}, src/main/scala/chisel3/util/OneHot.scala:65:27]
      if (_GEN_1)	// @[generators/rocket-chip/src/main/scala/tilelink/Fragmenter.scala:202:24, :220:27, :222:25, :223:19]
        dToggle <= auto_anon_out_d_bits_source[4];	// @[generators/rocket-chip/src/main/scala/tilelink/Fragmenter.scala:203:30, :224:41]
  ...
  `ifdef ENABLE_INITIAL_REG_	// @[generators/rocket-chip/src/main/scala/tilelink/Fragmenter.scala:92:9]
    ...
    initial begin	// @[generators/rocket-chip/src/main/scala/tilelink/Fragmenter.scala:92:9]
      ...
      `ifdef RANDOMIZE_REG_INIT	// @[generators/rocket-chip/src/main/scala/tilelink/Fragmenter.scala:92:9]
        ...
        acknum = _RANDOM[/*Zero width*/ 1'b0][3:0];	// @[generators/rocket-chip/src/main/scala/tilelink/Fragmenter.scala:92:9, :201:29]
        dOrig = _RANDOM[/*Zero width*/ 1'b0][6:4];	// @[generators/rocket-chip/src/main/scala/tilelink/Fragmenter.scala:92:9, :201:29, :202:24]
        dToggle = _RANDOM[/*Zero width*/ 1'b0][7];	// @[generators/rocket-chip/src/main/scala/tilelink/Fragmenter.scala:92:9, :201:29, :203:30]
        gennum = _RANDOM[/*Zero width*/ 1'b0][11:8];	// @[generators/rocket-chip/src/main/scala/tilelink/Fragmenter.scala:92:9, :201:29, :303:29]
        aToggle_r = _RANDOM[/*Zero width*/ 1'b0][12];	// @[generators/rocket-chip/src/main/scala/tilelink/Fragmenter.scala:92:9, :201:29, :309:54]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  Repeater_TLBundleA_a32d32s7k1z3u repeater (	// @[generators/rocket-chip/src/main/scala/tilelink/Fragmenter.scala:274:30]
    .clock               (clock),
    .reset               (reset),
  ...
  assign auto_anon_in_d_bits_source = auto_anon_out_d_bits_source[12:6];	// @[generators/rocket-chip/src/main/scala/tilelink/Fragmenter.scala:92:9, :238:47]
  ...
  assign auto_anon_out_a_bits_size = _repeater_io_deq_bits_size > 3'h2 ? 2'h2 : _repeater_io_deq_bits_size[1:0];	// @[generators/rocket-chip/src/main/scala/tilelink/Fragmenter.scala:92:9, :274:30, :297:{24,31}]
  assign auto_anon_out_a_bits_source = {_repeater_io_deq_bits_source, _repeater_io_deq_bits_opcode == 3'h0, ~(aFirst ? dToggle : aToggle_r), aFragnum};	// @[generators/rocket-chip/src/main/scala/tilelink/Fragmenter.scala:92:9, :203:30, :274:30, :288:49, :304:29, :305:30, :309:{23,27,54}, :317:33]
  assign auto_anon_out_a_bits_address = {_repeater_io_deq_bits_address[31:6], _repeater_io_deq_bits_address[5:0] | {~(aFragnum | _aOrigOH1_T[5:2]), 2'h0}};	// @[generators/rocket-chip/src/main/scala/tilelink/Fragmenter.scala:92:9, :274:30, :305:30, :316:{49,51,88,111}, generators/rocket-chip/src/main/scala/util/package.scala:243:{71,76}]
  assign auto_anon_out_a_bits_mask = _repeater_io_full ? 4'hF : auto_anon_in_a_bits_mask;	// @[generators/rocket-chip/src/main/scala/tilelink/Fragmenter.scala:92:9, :274:30, :325:31]
