...
module PLICClockSinkDomain(	// @[generators/rocket-chip/src/main/scala/prci/ClockDomain.scala:14:9]
  input         auto_plic_int_in_0,	// @[generators/diplomacy/diplomacy/src/diplomacy/lazymodule/LazyModuleImp.scala:107:25]
  ...
  input  [10:0] auto_plic_in_a_bits_source,	// @[generators/diplomacy/diplomacy/src/diplomacy/lazymodule/LazyModuleImp.scala:107:25]
  ...
  output [10:0] auto_plic_in_d_bits_source,	// @[generators/diplomacy/diplomacy/src/diplomacy/lazymodule/LazyModuleImp.scala:107:25]
  output [63:0] auto_plic_in_d_bits_data,	// @[generators/diplomacy/diplomacy/src/diplomacy/lazymodule/LazyModuleImp.scala:107:25]
  output        auto_int_in_clock_xing_out_sync_0,	// @[generators/diplomacy/diplomacy/src/diplomacy/lazymodule/LazyModuleImp.scala:107:25]
  ...
  wire _plic_auto_int_out_0;	// @[generators/rocket-chip/src/main/scala/devices/tilelink/Plic.scala:367:46]
  TLPLIC plic (	// @[generators/rocket-chip/src/main/scala/devices/tilelink/Plic.scala:367:46]
  ...
  );	// @[generators/rocket-chip/src/main/scala/devices/tilelink/Plic.scala:367:46]
  IntSyncCrossingSource_n1x1 intsource (	// @[generators/rocket-chip/src/main/scala/interrupts/Crossing.scala:29:31]
    .clock           (auto_clock_in_clock),
    .reset           (auto_clock_in_reset),
    .auto_in_0       (_plic_auto_int_out_0),	// @[generators/rocket-chip/src/main/scala/devices/tilelink/Plic.scala:367:46]
