...
module TLXbar_dmixbar_i1_o2_a9d32s1k1z2u(	// @[generators/rocket-chip/src/main/scala/tilelink/Xbar.scala:74:9]
  ...
  wire       requestAIO_0_0 = auto_anon_in_a_bits_address[8:6] == 3'h0 | {auto_anon_in_a_bits_address[8:7], _GEN[4:2], _GEN[0]} == 6'h0 | {auto_anon_in_a_bits_address[8:7], auto_anon_in_a_bits_address[6:3] ^ 4'hB} == 6'h0 | {auto_anon_in_a_bits_address[8:7], ~(auto_anon_in_a_bits_address[6:5])} == 4'h0 | {auto_anon_in_a_bits_address[8], ~(auto_anon_in_a_bits_address[7])} == 2'h0 | auto_anon_in_a_bits_address[8];	// @[generators/diplomacy/diplomacy/src/diplomacy/lazymodule/LazyModuleImp.scala:107:25, generators/rocket-chip/src/main/scala/diplomacy/Parameters.scala:137:{31,41,46,59}, generators/rocket-chip/src/main/scala/tilelink/Xbar.scala:222:41, :291:92]
  ...
  wire       _portsAOI_in_0_a_ready_T_2 = requestAIO_0_0 & auto_anon_out_0_a_ready | requestAIO_0_1 & auto_anon_out_1_a_ready;	// @[generators/rocket-chip/src/main/scala/tilelink/Xbar.scala:291:92, src/main/scala/chisel3/util/Mux.scala:30:73]
  ...
  wire       _in_0_d_bits_T = muxState_0 & auto_anon_out_0_d_bits_corrupt;	// @[generators/rocket-chip/src/main/scala/tilelink/Arbiter.scala:89:25, src/main/scala/chisel3/util/Mux.scala:30:73]
  wire       _in_0_d_bits_T_6 = muxState_0 & auto_anon_out_0_d_bits_denied;	// @[generators/rocket-chip/src/main/scala/tilelink/Arbiter.scala:89:25, src/main/scala/chisel3/util/Mux.scala:30:73]
  ...
  TLMonitor_31 monitor (	// @[generators/rocket-chip/src/main/scala/tilelink/Nodes.scala:27:25]
    ...
    .io_in_d_bits_denied  (_in_0_d_bits_T_6),	// @[src/main/scala/chisel3/util/Mux.scala:30:73]
    .io_in_d_bits_corrupt (_in_0_d_bits_T)	// @[src/main/scala/chisel3/util/Mux.scala:30:73]
  ...
  assign auto_anon_in_d_bits_denied = _in_0_d_bits_T_6;	// @[generators/rocket-chip/src/main/scala/tilelink/Xbar.scala:74:9, src/main/scala/chisel3/util/Mux.scala:30:73]
  ...
  assign auto_anon_in_d_bits_corrupt = _in_0_d_bits_T;	// @[generators/rocket-chip/src/main/scala/tilelink/Xbar.scala:74:9, src/main/scala/chisel3/util/Mux.scala:30:73]
